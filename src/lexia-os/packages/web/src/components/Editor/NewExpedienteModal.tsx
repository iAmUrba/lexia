...
export default function NewExpedienteModal({ isOpen, onClose, onSubmit, loading }: NewExpedienteModalProps) {
  const [formData, setFormData] = useState<ExpedienteFormData>({
    radicado: "",
    delitos: [""],
    procesados: [{ ...initialProcesado, defensor: { ...initialProcesado.defensor } }],
    demandante: "",
    fiscal: { nombre: "", despacho: "", seccional: "" },
    ministerio_publico: { nombre: "", despacho: "" },
    victimas: "",
    ...
    <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-md z-[100] flex items-center justify-center p-4">
      <div className="bg-slate-900/90 backdrop-blur-2xl rounded-3xl w-full max-w-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] border border-slate-700/50 shadow-black/50">
        ...
        <div className="px-8 py-6 border-b border-slate-800 flex items-center justify-between bg-slate-950/50 shrink-0">
          <div>
            <h2 className="text-xl font-black text-slate-200 tracking-tight">Crear Nuevo Expediente</h2>
